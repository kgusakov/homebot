...
impl fmt::Display for FileDownloadError {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    ...
    write!(f, "Error while trying to process telegram client call {}", cause_error_msg)
  }
}
...
impl TelegramClient {
  ...
  pub fn get_updates(&self) ->  reqwest::Result<TelegramResponse<Vec<Update>>> {
